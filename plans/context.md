...
- diagnose-feed-userid1: [Completed] Programmatically audited EF Core runtime model and query SQL (proven 0 shadow properties, UserId exists, UserId1 does NOT exist); ran local published runtime against production MySQL returning HTTP 200 OK with clean SQL; diagnosed production 500 error as stale IIS deployment running unrefreshed DLLs; 187/187 tests passing.
